...
class SimpleModel:
    def __init__(self, subsystem_tag):
        ...
        self._ss_dict = {"OFFLINE": 5, "STANDBY": 4, "DISABLED": 1,
                         "ENABLED": 2, "FAULT": 3, "MOVING": 6}
        self.state = "OFFLINE"
...
class SimpleCSC:
    def __init__(self, subsystem_tag, device_id=None):
        ...
        self.states = {"OFFLINE": OfflineState(self.subsystem_tag),
                       "STANDBY": StandbyState(self.subsystem_tag),
                       "DISABLED": DisabledState(self.subsystem_tag),
                       "ENABLED": EnabledState(self.subsystem_tag),
